...
//    freopen("output.txt", "w", stdout);
    ...
    for(int i=1;i<=n;i++){
        ...
        if(temp<=399) s.insert("a");
        else if(temp<=799) s.insert("b");
        else if(temp<=1199) s.insert("c");
        else if(temp<=1599) s.insert("d");
        else if(temp<=1999) s.insert("e");
        else if(temp<=2399) s.insert("f");
        else if(temp<=2799) s.insert("g");
        else if(temp<=3199) s.insert("h");
        else wild++;
